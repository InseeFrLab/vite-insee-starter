...
import { typography } from "@codegouvfr/react-dsfr/fr/generatedFromCss/typography";
...
} from "@codegouvfr/react-dsfr/useBreakpointsValuesPx";
    ...
    return {
        ...
        components: {
            ...
            MuiStepIcon: {
                styleOverrides: {
                    text: {
                        fill: fr.colors.getHex({ isDark: true }).decisions.text.title.grey.default
                    }
                }
            },
            MuiTablePagination: {
