...
export type PutTodoIdMutationBody = PutTodoIdBody | undefined;
...
export const usePutTodoId = <TError = unknown, TContext = unknown>(
    ...
    TContext
> => {
    return useMutation(getPutTodoIdMutationOptions(options), queryClient);
};

export const deleteTodoId = (
    id: string,
    options?: SecondParameter<typeof fetch>,
    signal?: AbortSignal
) => {
    return fetch<void>({ url: `/todo/${id}`, method: "DELETE", signal }, options);
};
...
export const useDeleteTodoId = <TError = unknown, TContext = unknown>(
    ...
    return useMutation(getDeleteTodoIdMutationOptions(options), queryClient);
};

export const putTodo = (
    putTodoBody?: PutTodoBody,
    options?: SecondParameter<typeof fetch>,
    signal?: AbortSignal
) => {
...
export type PutTodoMutationBody = PutTodoBody | undefined;
